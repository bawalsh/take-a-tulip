  ...
  return (
    <div>
      ...
      <div className="flex-container no-wrap">
        <img alt="" src={graphSVG} width="50" height="50" style={{ margin: '20px 20px 20px 0px', minWidth: '50px', minHeight: '50px' }} />
      ...
      <div className="flex-container no-wrap">
        <img alt="" src={bubbleSVG} width="50" height="50" style={{ margin: '20px 20px 20px 0px', minWidth: '50px', minHeight: '50px' }} />
        <p style={{ maxWidth: '480px' }}>It is generally considered the first recorded speculative bubble.</p>
      </div>
      <div className="flex-container no-wrap">
        <img alt="" src={valueSVG} width="50" height="50" style={{ margin: '20px 20px 20px 0px', minWidth: '50px', minHeight: '50px' }} />
      ...
      <div className="flex-container no-wrap">
        <img alt="" src={compareSVG} width="50" height="50" style={{ margin: '20px 20px 20px 0px', minWidth: '50px', minHeight: '50px' }} />
